...
output "monitoring_namespace" {
  ...
  value       = (var.enable_opensource_prometheus || var.enable_opensource_grafana) ? var.monitoring_namespace : null
}
...
output "helm_releases" {
  ...
  value = {
    ...
    kube_prometheus_stack  = (var.enable_opensource_prometheus || var.enable_opensource_grafana) ? helm_release.kube_prometheus_stack[0].name : null
